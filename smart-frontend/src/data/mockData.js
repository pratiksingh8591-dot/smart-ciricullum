...
export const ASSIGNMENTS = [
  ...
  { _id:'a2', title:'RSA Encryption Implementation', subjectId:'sub2', subjectName:'Cryptography & Network Security',
    ...
    dueDate:'2025-07-15', totalMarks:15, submitted:true, submittedAt:'2025-07-13', marks:13, feedback:'Excellent implementation! Key generation is efficient.', status:'graded' },
  { _id:'a3', title:'IoT Smart Home Prototype', subjectId:'sub3', subjectName:'Internet of Things',
    ...
    dueDate:'2025-07-20', totalMarks:25, submitted:true, submittedAt:'2025-07-18', marks:null, feedback:'', status:'submitted' },
...
export const ALL_SUBMISSIONS = {
  ...
  a2: [
    { studentId:'s1', studentName:'Rishi Chandel',   rollNo:'2024031', submittedAt:'2025-07-13', fileName:'rishi_rsa.py',    marks:13,   feedback:'Excellent!', status:'graded' },
  ...
  a3: [
    { studentId:'s1', studentName:'Rishi Chandel',   rollNo:'2024031', submittedAt:'2025-07-18', fileName:'rishi_iot.zip',   marks:null, feedback:'', status:'submitted' },
